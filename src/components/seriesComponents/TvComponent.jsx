...
const TvComponent = ({ modalDisplay, setId, page, genreId }) => {
  ...
  const fetchMovies = async () => {
    try {
      ...
      https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&with_watch_monetization_types=flatrate&page=${page}&with_genres=${genreId}`);
      setSkeleton(false);
